...
def visualize_instances_map(
    input_image, inst_map, type_map=None, type_colour=None, line_thickness=8
):
    ...
    for inst_idx, inst_id in enumerate(inst_list):
        ...
        #print(contours_crop.shape,contours_crop)
...
def visualize_instances_dict(
    ...
    for idx, [inst_id, inst_info] in enumerate(inst_dict.items()):
        ...
        cv2.imwrite('middle_results/'+str(idx)+'_overlay.png',overlay) 
        if draw_dot:
