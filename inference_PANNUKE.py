...
def __proc_np_hv(pred,fuse_mask):
    ...
    # processing
    blb = np.array(blb_raw >= 0.35, dtype=np.int32)
...
model_checkpoint_path = 'checkpoint_pannuke.pth' 
...
for file in files:
    ...
    #print(binary_map.shape,hv_map.shape)
    ...
    #@print(masks[select_mask].shape,hvs[select_mask].shape)
    ...
    sort_masks = []
    #sort_area = []
    for m,b,hv in zip(mask,bboxes,hvs):
