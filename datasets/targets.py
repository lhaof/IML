...
from datasets.misc.utils import center_pad_to_shape, cropping_center, get_bounding_box
from datasets.augs import fix_mirror_padding
...
def gen_instance_hv_map(ann):
    ...
    crop_ann = morph.remove_small_objects(fixed_ann, min_size=30)
