...
from .hover_utils import crop_op, crop_to_shape
...
class UpSample4x(nn.Module):
    ...
    def __init__(self):
        ...
        self.register_buffer(
            "unpool_mat", torch.from_numpy(np.ones((4, 4), dtype="float32"))
        )
    ...
    def forward(self, x):
        ...
        ret = ret.reshape((-1, input_shape[1], input_shape[2] * 4, input_shape[3] * 4))
        return ret
####
