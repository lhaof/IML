...
def parse_args():
    ...
    parser.add_argument("--cpus_per_task", default=1, type=int, help="Duration of the job")
...
def get_shared_folder() -> Path:
    user = os.getenv("USER")
    if Path("/mntnfs/med_data5/louwei/DINO/comp_robot").is_dir():
        p = Path(f"/mntnfs/med_data5/louwei/DINO/experiments")
